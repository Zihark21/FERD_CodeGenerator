    ...
    def _item_data(self):
        ...
        for i, data in enumerate(config.item_data):
            ...
            if data in ['Attack_Type', 'Weapon_Rank']:
                _width = config.option_width if data == "Weapon_Rank" else config.option_width*1.75
                ...
                option_menu.grid(row=i, column=1, pady=(0,5))
                option_menu.set('')
                ...
                checkbox.grid(row=i, column=1, sticky='ns')
